...
//=========================================================================================================
Ext.define('JdaPivotApp.model.datafilter.DataFilterDomains', {
    extend: 'Ext.data.Model',
    fields: [
        { name:'dimensionName', type:'string'},
        { name:'dimensionDisplayName', type:'string'},
        { name:'levelId', type:'string'},
        { name:'levelDisplayName', type:'string'},
        { name:'groupByLevel', type:'boolean'},
    ]
