...
//=========================================================================================================
Ext.define('JdaPivotApp.store.datafilter.DataFilterDomainDimensions', {
	 extend:'Ext.data.Store',
	 model: 'JdaPivotApp.model.datafilter.DataFilterDomainDimensions',
	 storeId:'dataFilterDomainDimensionsStore',
	 proxy: {
	        type: 'memory',
	        reader: {
	            type: 'json',
