...
//=========================================================================================================
Ext.define('JdaPivotApp.store.datafilter.DataFilterDomainLevels', {
	 extend:'Ext.data.Store',
	 model: 'JdaPivotApp.model.datafilter.DataFilterDomainLevels',
	 storeId:'dataFilterDomainLevelsStore',
	 proxy: {
	        type: 'memory',
	        reader: {
	            type: 'json',
